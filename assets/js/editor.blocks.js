...
/***/ "./blocks/components/detail-page/editor.scss":
/*!***************************************************!*\
  !*** ./blocks/components/detail-page/editor.scss ***!
  \***************************************************/
...
/***/ "./blocks/components/detail-page/index.js":
/*!************************************************!*\
  !*** ./blocks/components/detail-page/index.js ***!
  \************************************************/
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./blocks/components/detail-page/editor.scss");
...
var DetailPage = function (_wp$element$Component) {
	babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default()(DetailPage, _wp$element$Component);

	function DetailPage() {
		babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, DetailPage);

		return babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_4___default()(this, (DetailPage.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_1___default()(DetailPage)).apply(this, arguments));
	}

	babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(DetailPage, [{
		key: 'render',
		value: function render() {
			var _props = this.props,
			    ...
			    workflowInfo = _props.workflowInfo,
			    sidebar = _props.sidebar,
			    backLink = _props.backLink,
			    backLinkText = _props.backLinkText,
			    backLinkUrl = _props.backLinkUrl;


			var dummyValue = React.createElement('div', { className: 'field-value' });

			var workflowInfoEl = workflowInfo && React.createElement(
				'div',
				{ key: 'gravityflow-workflow-details', id: 'gravityflow-workflow-details' },
				React.createElement(
					'strong',
					null,
					__('Workflow', 'gravityflow')
				),
				React.createElement(
					'div',
					{ id: 'entry-id' },
					__('Entry ID:', 'gravityflow'),
					' ',
					dummyValue
				),
				React.createElement(
					'div',
					{ id: 'submitted' },
					__('Submitted:', 'gravityflow'),
					dummyValue
				),
				React.createElement(
					'div',
					{ id: 'created-by' },
					__('Submitted by:', 'gravityflow'),
					dummyValue
				),
				React.createElement(
					'div',
					{ id: 'status' },
					__('Status:', 'gravityflow'),
					dummyValue
				),
				React.createElement('hr', { style: { marginTop: '10px' } })
			);

			var stepStatusEl = stepStatus && React.createElement(
				'div',
				{ key: 'gravityflow-step-status', id: 'gravityflow-step-status' },
				React.createElement(
					'div',
					{ key: 'step-status', id: 'step-status' },
					React.createElement(
						'strong',
						null,
						__('Step Name (Status)', 'gravityflow')
					)
				),
				React.createElement(
					'div',
					{ key: 'assignee-status', id: 'assignee-status' },
					__('Assignee:', 'gravityflow'),
					dummyValue,
					' ',
					__('(status)', 'gravityflow')
				)
			...
			var timelineItem = function timelineItem(i) {
				return React.createElement(
					'div',
					{ key: 'timeline-item-' + i, className: 'timeline-item' },
					React.createElement('div', { className: 'timeline-icon' }),
					React.createElement(
						'div',
						...
						React.createElement(
							...
							React.createElement('div', { className: 'timeline-user' }),
							React.createElement('div', { className: 'timeline-date' })
						),
						React.createElement('div', { className: 'timeline-note' }),
						React.createElement('div', { className: 'timeline-note-half' })
					)
				);
			};

			var timelinePreview = timeline && React.createElement(
				'div',
				{ key: 'timeline' },
				React.createElement(
					'strong',
					null,
					__('Timeline', 'gravityflow')
				),
				React.createElement(
					'div',
					{ id: 'timeline' },
			...
			var workflowBox = React.createElement(
				'div',
				{ key: 'workflow-box' },
				workflowInfoEl,
				stepStatusEl
			...
			var fieldValue = function fieldValue(i) {
				return React.createElement(
					'div',
					{ key: 'field-value-' + i },
					React.createElement(
			...
			return [React.createElement(
				...
				React.createElement(
					...
					React.createElement(ToggleControl, {
						...
						onChange: function onChange() {
							return setAttributes({ timeline: !timeline });
						}
					}),
					React.createElement(ToggleControl, {
						...
						checked: stepStatus,
						onChange: function onChange() {
							return setAttributes({ stepStatus: !stepStatus });
						}
					}),
					React.createElement(ToggleControl, {
						...
						onChange: function onChange() {
							return setAttributes({ workflowInfo: !workflowInfo });
						}
					}),
					React.createElement(ToggleControl, {
						...
						checked: sidebar,
						onChange: function onChange() {
							return setAttributes({ sidebar: !sidebar });
						}
					}),
					React.createElement(ToggleControl, {
						...
						checked: backLink,
						onChange: function onChange() {
							return setAttributes({ backLink: !backLink });
						}
					}),
					backLink && React.createElement(
						...
						React.createElement(TextControl, {
							...
							value: backLinkText,
							onChange: function onChange(newBackLinkText) {
								return setAttributes({ backLinkText: newBackLinkText });
							}
						}),
						React.createElement(TextControl, {
							label: __('Custom Inbox URL (Optional)', 'gravityforms'),
							value: backLinkUrl,
							onChange: function onChange(newBackLinkUrl) {
								return setAttributes({ backLinkUrl: newBackLinkUrl });
							}
						})
					)
				)
				...
				'div',
				{ key: 'detail-view', id: 'detail-view', className: 'detail-view' },
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'div',
							{ id: 'entry-details' },
							[].concat(babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(Array(5))).map(function (_, i) {
								return fieldValue(i);
							})
						),
						!sidebar && workflowBox,
...
/***/ "./blocks/components/entry-table/check.js":
/*!************************************************!*\
  !*** ./blocks/components/entry-table/check.js ***!
  \************************************************/
/*! exports provided: default */
...
/***/ "./blocks/components/entry-table/editor.scss":
/*!***************************************************!*\
  !*** ./blocks/components/entry-table/editor.scss ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./blocks/components/entry-table/filters.js":
/*!**************************************************!*\
  !*** ./blocks/components/entry-table/filters.js ***!
  \**************************************************/
/*! exports provided: default */
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./blocks/components/entry-table/editor.scss");
...
var Filters = function (_wp$element$Component) {
	babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(Filters, _wp$element$Component);

	function Filters() {
		babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, Filters);

		return babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_3___default()(this, (Filters.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_0___default()(Filters)).apply(this, arguments));
	}

	babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Filters, [{
		key: "render",
		value: function render() {
			var forms_count = this.props.forms_count;


			return React.createElement(
				"div",
				{ className: "gravityflow-filters" },
				React.createElement(
					"div",
					{ className: "gravityflow-id-input" },
					__('ID', 'gravityflow')
				),
				__('Start:', 'gravityflow'),
				React.createElement(
					"div",
					{ className: "gravityflow-date-input" },
					__('yyyy-mm-dd', 'gravityflow')
				),
				__('End:', 'gravityflow'),
				React.createElement(
					"div",
				...
				forms_count !== 1 && React.createElement(
					"div",
					{ className: "gravityflow-filter-select" },
				...
				React.createElement(
					"div",
					{ className: "gravityflow-filter-button" },
...
/***/ "./blocks/components/entry-table/index.js":
/*!************************************************!*\
  !*** ./blocks/components/entry-table/index.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./editor.scss */ "./blocks/components/entry-table/editor.scss");
...
/* harmony import */ var _lock__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./lock */ "./blocks/components/entry-table/lock.js");
/* harmony import */ var _check__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./check */ "./blocks/components/entry-table/check.js");
/* harmony import */ var _times__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./times */ "./blocks/components/entry-table/times.js");
/* harmony import */ var _filters__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./filters */ "./blocks/components/entry-table/filters.js");
...
var EntryTable = function (_wp$element$Component) {
	babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_7___default()(EntryTable, _wp$element$Component);

	function EntryTable() {
		babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_4___default()(this, EntryTable);

		return babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_6___default()(this, (EntryTable.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_3___default()(EntryTable)).apply(this, arguments));
	}

	babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_5___default()(EntryTable, [{
		key: 'render',
		value: function render() {
			var _props = this.props,
			    stepHighlight = _props.stepHighlight,
			    idColumn = _props.idColumn,
			    submitterColumn = _props.submitterColumn,
			    stepColumn = _props.stepColumn,
			    actionsColumn = _props.actionsColumn,
			    lastUpdated = _props.lastUpdated,
			    dueDate = _props.dueDate,
			    className = _props.className,
			    selectedForms = _props.selectedForms,
			    selectedFields = _props.selectedFields,
			    entryData = _props.entryData,
			    liveData = _props.liveData,
			    columnOrder = _props.columnOrder,
			    displayFilters = _props.displayFilters;
			...
			var columns = [];
			babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_2___default()(orderedColumns).map(function (key) {
				if (key === 'fields') {
			...
			if (!liveData) {
				...
				columns.forEach(function (column, i) {
					row[column.key] = React.createElement(
						'div',
						{ style: { width: 'auto', backgroundColor: '#eee', height: '10px' } },
						'\xA0'
					);
				});
				entryData.rows = [].concat(babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1___default()(Array(10))).map(function (_, i) {
					var newRow = {};
					babel_runtime_core_js_object_assign__WEBPACK_IMPORTED_MODULE_0___default()(newRow, row);
					newRow.id = i + 1;
					if (i === 0) {
			...
			return React.createElement(
				'div',
				null,
				displayFilters && React.createElement(_filters__WEBPACK_IMPORTED_MODULE_12__["default"], { formsCount: selectedForms.length }),
				React.createElement(
					'table',
					{ className: 'gravityflow-entry-table' },
					React.createElement(
						'thead',
						null,
						React.createElement(
					...
					React.createElement(
						'tbody',
						null,
						entryData.rows.map(function (row) {
							var highlightColor = stepHighlight ? row.step_highlight : '';
							return React.createElement(
								'tr',
								{ key: row.id, style: { borderColor: highlightColor } },
								columns.map(function (column) {
									var key = column.key;
									var val = key === 'actions' ? React.createElement(
										'div',
										{ className: 'gravityflow-actions' },
										_lock__WEBPACK_IMPORTED_MODULE_9__["default"],
										' ',
										_check__WEBPACK_IMPORTED_MODULE_10__["default"],
										' ',
										_times__WEBPACK_IMPORTED_MODULE_11__["default"]
									) : row[key];
									return React.createElement(
										'td',
										{ key: key },
...
/* harmony default export */ __webpack_exports__["default"] = (EntryTable);

/***/ }),

/***/ "./blocks/components/entry-table/lock.js":
/*!***********************************************!*\
  !*** ./blocks/components/entry-table/lock.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var lock = React.createElement(
  "svg",
  { width: "15", height: "15", viewBox: "0 0 1792 1792", xmlns: "http://www.w3.org/2000/svg" },
  React.createElement("path", { d: "M640 768h512v-192q0-106-75-181t-181-75-181 75-75 181v192zm832 96v576q0 40-28 68t-68 28h-960q-40 0-68-28t-28-68v-576q0-40 28-68t68-28h32v-192q0-184 132-316t316-132 316 132 132 316v192h32q40 0 68 28t28 68z" })
);
...
/***/ "./blocks/components/entry-table/times.js":
/*!************************************************!*\
  !*** ./blocks/components/entry-table/times.js ***!
  \************************************************/
/*! exports provided: default */
...
/***/ "./blocks/components/form-select.js":
/*!******************************************!*\
  !*** ./blocks/components/form-select.js ***!
  \******************************************/
/*! exports provided: default */
...
var FormSelectView = function (_wp$element$Component) {
	babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default()(FormSelectView, _wp$element$Component);

	function FormSelectView() {
		babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, FormSelectView);

		return babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_4___default()(this, (FormSelectView.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_1___default()(FormSelectView)).apply(this, arguments));
	}

	babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(FormSelectView, [{
		key: 'render',
		value: function render() {
			var _props = this.props,
			    selectedForms = _props.selectedForms,
			...
			var form = selectedForms.length === 1 ? forms[selectedForms.map(function (item) {
				return item.value;
			})] : false;
			if (form) {
				babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(form.fields).forEach(function (key, i) {
					var field = form.fields[key];
					if (field.inputs) {

						var groupOptions = field.inputs.map(function (item) {
							return {
								label: item['label'],
								value: item['id']
							};
...
var FormSelect = withSelect(function (select) {
	return {
...
var Select = function (_wp$element$Component) {
	babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(Select, _wp$element$Component);

	function Select() {
		babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, Select);

		return babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_3___default()(this, (Select.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_0___default()(Select)).apply(this, arguments));
	}
	...
	babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Select, [{
		...
		value: function render() {
			...
			var handleChange = function handleChange(selectedValues) {
			...
			return React.createElement(
				BaseControl,
				{ label: label, id: id, help: help, className: className },
				React.createElement(react_select__WEBPACK_IMPORTED_MODULE_5__["default"], {
					isMulti: isMulti,
					value: value,
...
/* harmony default export */ __webpack_exports__["default"] = (withState()(Select));

/***/ }),

/***/ "./blocks/inbox/edit.js":
/*!******************************!*\
  !*** ./blocks/inbox/edit.js ***!
  \******************************/
/*! exports provided: default */
...
/* harmony import */ var babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! babel-runtime/helpers/inherits */ "./node_modules/babel-runtime/helpers/inherits.js");
/* harmony import */ var babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _components_form_select__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/form-select */ "./blocks/components/form-select.js");
/* harmony import */ var _components_detail_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/detail-page */ "./blocks/components/detail-page/index.js");
/* harmony import */ var _components_entry_table__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/entry-table */ "./blocks/components/entry-table/index.js");
...
var Edit = function (_wp$element$Component) {
	babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default()(Edit, _wp$element$Component);

	function Edit() {
		babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, Edit);

		return babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_4___default()(this, (Edit.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_1___default()(Edit)).apply(this, arguments));
	}
	...
	babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(Edit, [{
		...
		value: function componentDidUpdate(prevProps) {
			if (prevProps.selectedForms !== this.props.selectedForms || prevProps.selectedFields !== this.props.selectedFields) {
				this.getInboxEntries(this.props.selectedForms.map(function (item) {
					return item.value;
				}), this.props.selectedFields.map(function (item) {
					return item.value;
				}));
			}
		}
		...
		key: 'getInboxEntries',
		value: function getInboxEntries(formIds, fields) {
			var _this2 = this;

			apiFetch({
				path: addQueryArgs('/gf/v2/inbox-entries/', { 'form-ids': formIds, fields: fields, 'last-updated': true, 'due-date': true, 'actions-column': true })
			}).then(function (entryData) {
				_this2.props.setState({ entryData: entryData, loaded: true });
			}).catch(function () {
				_this2.props.setState({ entryData: [], loaded: true });
			});
		}
	}, {
		key: 'render',
		value: function render() {
			...
			var _props = this.props,
			    ...
			    stepHighlight = _props$attributes.stepHighlight,
			    idColumn = _props$attributes.idColumn,
			    submitterColumn = _props$attributes.submitterColumn,
			    stepColumn = _props$attributes.stepColumn,
			    actionsColumn = _props$attributes.actionsColumn,
			    lastUpdated = _props$attributes.lastUpdated,
			    dueDate = _props$attributes.dueDate,
			    selectedFormsJson = _props$attributes.selectedFormsJson,
			    selectedFieldsJson = _props$attributes.selectedFieldsJson,
			    timeline = _props$attributes.timeline,
			    stepStatus = _props$attributes.stepStatus,
			    workflowInfo = _props$attributes.workflowInfo,
			    sidebar = _props$attributes.sidebar,
			    backLink = _props$attributes.backLink,
			    backLinkText = _props$attributes.backLinkText,
			    backLinkUrl = _props$attributes.backLinkUrl,
			    setAttributes = _props.setAttributes,
			    setState = _props.setState,
			...
			var selectedFields = !selectedFieldsJson ? [] : JSON.parse(selectedFieldsJson);
			var selectedForms = !selectedFormsJson ? [] : JSON.parse(selectedFormsJson);
			var isDetail = currentView === 'detail';

			var columnOrder = ['id', 'actions', 'form_title', 'created_by', 'workflow_step', 'date_created', 'fields', 'last_updated', 'due_date'];
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							Button,
							{
								...
								onClick: function onClick() {
									return setState({ currentView: 'list' });
								},
								style: { zIndex: 0 },
								isPrimary: !isDetail },
							__('List', 'gravityflow')
						...
						React.createElement(
							Button,
							{
								...
								isDefault: true,
								onClick: function onClick() {
									return setState({ currentView: 'detail' });
								},
								style: { zIndex: 0 },
								isPrimary: isDetail },
							'Detail'
					...
					!isDetail && React.createElement(
						...
						React.createElement(ToggleControl, {
							...
							checked: liveData,
							onChange: function onChange() {
								_this3.getInboxEntries(selectedForms.map(function (item) {
									return item.value;
				...
				!isDetail && React.createElement(
					...
					React.createElement(
						...
						React.createElement(ToggleControl, {
							...
							onChange: function onChange() {
								return setAttributes({ stepHighlight: !stepHighlight });
							}
						}),
						React.createElement(ToggleControl, {
							...
							checked: idColumn,
							onChange: function onChange() {
								return setAttributes({ idColumn: !idColumn });
							}
						}),
						React.createElement(ToggleControl, {
							...
							onChange: function onChange() {
								return setAttributes({ actionsColumn: !actionsColumn });
							}
						}),
						React.createElement(ToggleControl, {
							...
							onChange: function onChange() {
								return setAttributes({ submitterColumn: !submitterColumn });
							}
						}),
						React.createElement(ToggleControl, {
							...
							checked: stepColumn,
							onChange: function onChange() {
								return setAttributes({ stepColumn: !stepColumn });
							}
						}),
						React.createElement(ToggleControl, {
							...
							checked: lastUpdated,
							onChange: function onChange() {
								return setAttributes({ lastUpdated: !lastUpdated });
							}
						}),
						React.createElement(ToggleControl, {
							...
							checked: dueDate,
							onChange: function onChange() {
								return setAttributes({ dueDate: !dueDate });
							}
						}),
						React.createElement(_components_form_select__WEBPACK_IMPORTED_MODULE_6__["default"], {
							selectedForms: selectedForms,
							selectedFields: selectedFields,
							onFormsChange: function onFormsChange(selectedForms) {
								setAttributes({ selectedFormsJson: babel_runtime_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(selectedForms), selectedFieldsJson: '' });
								var ids = selectedForms.map(function (item) {
									return item.value;
								});
								_this3.getInboxEntries(ids, []);
							},
							onFieldsChange: function onFieldsChange(selectedFields) {
								setAttributes({ selectedFieldsJson: babel_runtime_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(selectedFields) });
								var fieldIds = selectedFields.map(function (item) {
									return item.value;
								});
								_this3.getInboxEntries(selectedForms.map(function (item) {
									return item.value;
			...
			), !isDetail && React.createElement(_components_entry_table__WEBPACK_IMPORTED_MODULE_8__["default"], { key: 'gravityflow-inbox', stepHighlight: stepHighlight, idColumn: idColumn,
				submitterColumn: submitterColumn, stepColumn: stepColumn,
				actionsColumn: actionsColumn, lastUpdated: lastUpdated, dueDate: dueDate,
				selectedForms: selectedForms, selectedFields: selectedFields, liveData: liveData, entryData: entryData, columnOrder: columnOrder }), isDetail && React.createElement(_components_detail_page__WEBPACK_IMPORTED_MODULE_7__["default"], { key: 'gravityflow-detail', timeline: timeline, stepStatus: stepStatus, workflowInfo: workflowInfo,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _icon__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./icon */ "./blocks/inbox/icon.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./editor.scss */ "./blocks/inbox/editor.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_editor_scss__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./blocks/inbox/edit.js");
/* Copyright (C) 2019 Steven Henty S.L. - All Rights Reserved */
...
registerBlockType('gravityflow/inbox', {
	...
	babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(Edit, [{
		...
		value: function render() {
			var _props = this.props,
			    ...
			    backLinkText = _props$attributes.backLinkText,
			    backLinkUrl = _props$attributes.backLinkUrl,
			    displayAll = _props$attributes.displayAll,
			    allowAnonymous = _props$attributes.allowAnonymous,
			    setAttributes = _props.setAttributes,
			    setState = _props.setState,
			    currentView = _props.currentView,
			    liveData = _props.liveData;
			...
			var columnOrder = ['id', 'date_created', 'form_title', 'created_by', 'workflow_step', 'workflow_final_status', 'fields', 'last_updated', 'due_date'];
			...
			), !isDetail && React.createElement(_components_entry_table__WEBPACK_IMPORTED_MODULE_8__["default"], { key: 'gravityflow-status', idColumn: idColumn,
				submitterColumn: submitterColumn, stepColumn: stepColumn,
				lastUpdated: lastUpdated, dueDate: dueDate,
				selectedForms: selectedForms, selectedFields: selectedFields, liveData: liveData, entryData: { rows: [] }, columnOrder: columnOrder, displayFilters: true }), isDetail && React.createElement(_components_detail_page__WEBPACK_IMPORTED_MODULE_7__["default"], { key: 'gravityflow-detail', timeline: timeline, stepStatus: stepStatus, workflowInfo: workflowInfo,
				sidebar: sidebar, backLink: backLink, backLinkText: backLinkText,
				backLinkUrl: backLinkUrl, setAttributes: setAttributes })];
		}
	}]);
...
/* harmony default export */ __webpack_exports__["default"] = (withState({ currentView: 'list' })(Edit));

/***/ }),

/***/ "./blocks/status/editor.scss":
/*!***********************************!*\
  !*** ./blocks/status/editor.scss ***!
  \***********************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _icon__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./icon */ "./blocks/status/icon.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./editor.scss */ "./blocks/status/editor.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_editor_scss__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./blocks/status/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./blocks/status/edit.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../store */ "./blocks/store.js");
...
registerBlockType('gravityflow/status', {
...
var actions = {
	...
	receiveForms: function receiveForms(path) {
		return {
			type: 'RECEIVE_FORMS',
			path: path
		};
...
var store = registerStore('gravityflow/workflow', {
	...
	selectors: {
		receiveForms: function receiveForms(state) {
	...
	controls: {
		RECEIVE_FORMS: function RECEIVE_FORMS(action) {
			return apiFetch({ path: action.path });
		}
	},

	resolvers: {
		receiveForms: /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function receiveForms() {
			var forms;
			return babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function receiveForms$(_context) {
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							...
							_context.prev = 1;
							_context.next = 4;
							return actions.receiveForms('/gf/v2/workflow/forms/');
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../store */ "./blocks/store.js");
...
var Edit = function (_wp$element$Component) {
	...
	babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(Edit, [{
		...
		value: function render() {
			...
			var formsList = displayForms.map(function (form) {
				return React.createElement(
					'div',
					{ key: form.value },
					form.label
			...
			return [React.createElement(
				...
				React.createElement(_components_form_select__WEBPACK_IMPORTED_MODULE_7__["default"], {
					selectedForms: selectedForms,
					onFormsChange: function onFormsChange(selectedForms) {
						setAttributes({ selectedFormsJson: babel_runtime_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(selectedForms) });
					}
				})
			), React.createElement(
				'div',
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _icon__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./icon */ "./blocks/submit/icon.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./editor.scss */ "./blocks/submit/editor.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_editor_scss__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./blocks/submit/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./blocks/submit/edit.js");
/* Copyright (C) 2019 Steven Henty S.L. - All Rights Reserved */
